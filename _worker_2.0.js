...
// ✅ 智能批量队列常量（借鉴 v8.5.3.js）
const MERGE_MAX=10240          // 10KB，最大合并大小
const MERGE_THRESHOLD=9         // 9个包，触发合并的数量阈值
const FAST_THRESHOLD=5120       // 5KB，超过这个大小立即发送
const Q_SIZE=32                 // 队列大小
const Q_MASK=31                 // 队列掩码
const QB_MAX=196608             // 队列最大字节数
const BATCH_MAX=14              // 单次最多处理14个包
...
Uplink.prototype.drain=async function(){
  if(this.lock||this.qh===this.qt)return
